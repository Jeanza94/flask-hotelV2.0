...
class registerForm(FlaskForm) :
    ...
    cargo = SelectField('Role', choices= [('cliente','cliente'),('administrador','administrador'),('super administrador','super adminisrador')])

class reservation (FlaskForm):

    habitacion = SelectField('Habitación', choices=[
    ...
    dias = IntegerField('Días a reservar', validators=[
        DataRequired()
    ])
